...
CellGeoBasic::CellGeoBasic():type(ghost), NN(0), NF(0), S(0), characteristic_length(0), dist_wall(0), allocated(false)
{

}


CellGeoBasic::CellGeoBasic(const int ND, const CellType c_type): type(c_type), x(ND, 0.0), allocated(true)
{
	switch(type)
	{
	case CellType::ghost:
