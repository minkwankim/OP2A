...
void ApplicationOP2A::create_sampleDataCFD()
{
	 ...
	 */
	// Cell
	cell_data1D_template = CFD::CFD_DataTemplateWIG::CellData1D(species_set, grid.ND, problem_setup.NER,  problem_setup.NEV,  problem_setup.NEE,  problem_setup.is_viscous,  problem_setup.is_axisymmetric, problem_setup.TIME_INTEGRATION_METHOD);
	cell_data2D_template = CFD::CFD_DataTemplateWIG::CellData2D(species_set, grid.ND, problem_setup.NER,  problem_setup.NEV,  problem_setup.NEE,  problem_setup.is_viscous,  problem_setup.is_axisymmetric, problem_setup.TIME_INTEGRATION_METHOD);

	// Face
	face_data1D_template = CFD::CFD_DataTemplateWIG::FaceData1D(species_set, grid.ND, problem_setup.NER,  problem_setup.NEV,  problem_setup.NEE,  problem_setup.is_viscous,  problem_setup.is_axisymmetric, problem_setup.TIME_INTEGRATION_METHOD);
	face_data2D_template = CFD::CFD_DataTemplateWIG::FaceData2D(species_set, grid.ND, problem_setup.NER,  problem_setup.NEV,  problem_setup.NEE,  problem_setup.is_viscous,  problem_setup.is_axisymmetric, problem_setup.TIME_INTEGRATION_METHOD);
