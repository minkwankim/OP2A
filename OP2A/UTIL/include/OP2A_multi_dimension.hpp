 ...
 *      			Author: Minkwan Kim
 *
 * OP2A_multi_dimention_pointer.hpp
 * 			-  
 *  
 */

#ifndef OP2A_MULTI_DIMENTION_POINTER_HPP_
#define OP2A_MULTI_DIMENTION_POINTER_HPP_
...
#endif /* OP2A_MULTI_DIMENTION_POINTER_HPP_ */
