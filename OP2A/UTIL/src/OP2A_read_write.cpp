...
#include "../include/OP2A_read_write.hpp"



// ::F-01
// Read date from string data
string data_read::get_data_from_string_string(string line, string TEXT)
{
	int num;
	string result;
...
string data_read::remove_space_front(string line)
{
	int i, num;
	string result;
...
string data_read::remove_space_end(string line)
{
	int i, num, num_temp;
	string result;
...
// ::F-04
// Remove comments
void data_read::remove_comments(string& line, string comment_s, string comment_e)
{
	string result_text;
...
void data_read::remove_comments(string& line, string comment_s)
{
	string result_text;
...
// ::F-05
// Read line
void data_read::read_line(string& line)
{
	/////////////////////////////////////////////////////
